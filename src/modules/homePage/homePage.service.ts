...
const upsertHeroSectionTeacher = async (payload: {
  ...
  const result = await prisma.heroSectionTeacher.upsert({
    ...
    update: {
      ...
      ...(payload.displayDesignation !== undefined && { displayDesignation: payload.displayDesignation }),
      ...(payload.displayDepartment !== undefined && { displayDepartment: payload.displayDepartment }),
      ...(payload.displayBio !== undefined && { displayBio: payload.displayBio }),
